...
(
   ...
   ID_QUERY_CHROMOSOME  INTEGER        NOT NULL,
   ID_QUERY_GENOME      INTEGER        NOT NULL,
   ID_TARGET_ORF        BIGINT         NOT NULL,
   ID_TARGET_CHROMOSOME INTEGER        NOT NULL,
   ID_TARGET_GENOME     INTEGER        NOT NULL,
   ITERATION            XML            NOT NULL,
...
ALTER TABLE APP.BLASTS
  ADD CONSTRAINT QUERY_CHROMOSOME_ID_BLAST_REF FOREIGN KEY (ID_QUERY_CHROMOSOME)
  REFERENCES APP.CHROMOSOMES (ID_CHROMOSOME)
  ON UPDATE RESTRICT
  ON DELETE CASCADE;

ALTER TABLE APP.BLASTS
  ADD CONSTRAINT TARGET_CHROMOSOME_ID_BLAST_REF FOREIGN KEY (ID_TARGET_CHROMOSOME)
  REFERENCES APP.CHROMOSOMES (ID_CHROMOSOME)
  ON UPDATE RESTRICT
  ON DELETE CASCADE;
